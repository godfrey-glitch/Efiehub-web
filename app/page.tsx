...
function HeroCanvas() {
  ...
  useEffect(() => {
    ...
    const houseMesh = new THREE.Mesh(new THREE.BoxGeometry(3,2,2.5), new THREE.MeshPhongMaterial({color:0xffffff,shininess:80,transparent:true,opacity:0.9}));
    houseMesh.position.set(0,1,0);
    hg.add(houseMesh);
    ...
    gridMat.opacity=0.07; gridMat.transparent=true; grid.position.y=-2.5; scene.add(grid);
